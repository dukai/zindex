...
exports.tmpl = function(str){
	...
	var content = cache[str] ? cache[str] : (cache[str] = fs.readFileSync(str, 'utf8'));
	...
	return {
		render: function(data){
			...
			return new Function(formalParams, "var ___tp = [], print = function(){___tp.push.apply___tp.push.apply(___tp, arguments);};___tp.push('" + content + "');return ___tp;").apply(null, actualParams).join("");
		}
	};
};
