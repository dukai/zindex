...
Route.prototype = {
	_initRoute:function(options){
		...
		this._url = stringUtil.trim(options.url, Route.URL_DELIMITER);
...
exports.dispatch = function(intent){
    ...
    var controllerPath = getControllerPath(Config.app_path, routeResult.getController());
    ...
    fs.exists(controllerPath, function(exists){
        if(exists){
            ...
            intent.params = {};
            controllerPath = getControllerPath(Config.app_path, 'error');
        }
