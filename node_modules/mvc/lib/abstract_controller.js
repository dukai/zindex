...
AbstractController.prototype = {
    ...
    dispatchAction: function(){
        if(this[this.actionName]){
            ...
            this.forward({
                ...
                params: {status: 404, message: '<h1>Action NOT Found!</h1><hr />Powered by dk'}
            });
        }
    },
	...
	render: function (){
		...
		this.view.renderScript(function(viewContent){
			self.response.writeHead(self.statusCode, {'Content-Type': 'text/html; charset=utf-8'});
